...
export type { MainV2test } from "./MainV2test";
export type { MainV3test } from "./MainV3test";
...
export { MainV2test__factory } from "./factories/MainV2test__factory";
export { MainV3test__factory } from "./factories/MainV3test__factory";
