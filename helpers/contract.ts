...
import { Main } from "types/typechain/Main";
...
const defaultChainId = chain.polygon.id;
...
const chainIdToMainContractAddressMapping = {
  [chain.polygonMumbai.id]: "0x70Ed3Cf756dBbaB9aEB7bbfB7Bd52E9a1ed37fCe",
};
...
export const getEvents = (
  args: Parameters<typeof Main.prototype.events>[0],
  chainIds: Chain["id"][] = [defaultChainId]
) =>
  useContractReads({
    contracts: chainIds.map((chainId) => ({
...
const createEvent = (
  args: Parameters<typeof Main.prototype.createEvent>[0],
...
const getEventManagers = (
  args: Parameters<typeof Main.prototype.getEventManagers>[0],
  chainIds: Chain["id"][] = [defaultChainId]
) =>
  useContractReads({
    contracts: chainIds.map((chainId) => ({
