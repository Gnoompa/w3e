...
const Theme: ThemeType = {
  ...
  colors: {
    ...
    dialogFieldBackground:
      "linear-gradient(95deg, #F342F3 -28.36%, #ECB5FF 29.02%, #BDD7FF 79.22%, #ECF4FF 115.08%)",
    foreground: "#f5edf47d",
    bg: "#F1F1F1",
    primary: "#1F2421",
    gradient:
      "linear-gradient(95deg, #F342F3 -28.36%, #ECB5FF 29.02%, #BDD7FF 79.22%, #ECF4FF 115.08%)",
    gradient2:
      "linear-gradient(94.24deg, #FF8DFF -28.89%, rgba(243, 66, 243, 0.66) 6.46%, rgba(228, 0, 10, 0.38) 27.51%, rgba(165, 226, 226, 0.19) 87.69%, rgba(217, 217, 217, 0) 115.49%, #E46ED9 115.51%)",
    invalid:
      "linear-gradient(90deg, #FF0000 0.41%, #FF8DFF 100.41%), linear-gradient(0deg, #FFFFFF, #FFFFFF)",
    dialog:
      "radial-gradient(117.47% 137.15% at 20.35% 117.81%, #EE99FD 0%, #ECDEEC 100%)",
    dialogHover:
      "radial-gradient(117.47% 137.15% at 20.35% 117.81%, #EE99FD 0%, #f3cef3 100%)",
    modes: {
      dark: darkTheme,
    },
  },
  ...
  styles: {
    ...
    nav: {
      ...
      boxShadow:
        "0px 2px 2px rgb(0 0 0 / 12%), inset 0px 2px 2px rgb(0 0 0 / 12%)",
    },
    hr: {
      nav: {
        background: "#ffffffb3",
  ...
  layout: {
    container: {
      accent: {
        background: "linear-gradient(111.62deg, #171717 0%, #202020 96.72%)",
        borderRadius: "36px",
        padding: "4rem 2rem",
      },
